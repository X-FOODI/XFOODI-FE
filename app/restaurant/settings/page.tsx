        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8" style={{ background: "var(--bg-base)" }}>
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Cài đặt Cửa hàng</h1>
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Quản lý thông tin và giao diện trang nhà hàng của bạn.</p>
              </div>
              <button 
                onClick={handleSave}
                disabled={saving}
            ...
            <div className="flex space-x-1 bg-gray-100/50 dark:bg-gray-800/50 p-1 rounded-lg">
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${
                  activeTab === "general" 
                    ? "bg-white dark:bg-gray-700 shadow text-slate-900 dark:text-slate-100" 
            ...
            {activeTab === "general" && (
              <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm space-y-4">
                  <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Thông tin cơ bản</h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Tên nhà hàng <span className="text-red-500">*</span></label>
                      <input type="text" value={formData.name} onChange={(e) => setFormData({...formData, name: e.target.value})} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-transparent text-slate-900 dark:text-slate-100" />
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Email liên hệ</label>
                      <input type="email" value={formData.email} onChange={(e) => setFormData({...formData, email: e.target.value})} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-transparent text-slate-900 dark:text-slate-100" />
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Số điện thoại (Hotline)</label>
                      <input type="text" value={formData.phone} onChange={(e) => setFormData({...formData, phone: e.target.value})} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-transparent text-slate-900 dark:text-slate-100" />
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Địa chỉ</label>
                      <input type="text" value={formData.address} onChange={(e) => setFormData({...formData, address: e.target.value})} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-transparent text-slate-900 dark:text-slate-100" />
                    </div>
                    <div className="md:col-span-2 space-y-1.5">
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Câu chuyện nhà hàng (Mô tả)</label>
                      <textarea rows={4} value={formData.description} onChange={(e) => setFormData({...formData, description: e.target.value})} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-transparent resize-none text-slate-900 dark:text-slate-100" placeholder="Kể câu chuyện về nhà hàng của bạn..." />
                    </div>
                  </div>
                </div>
                ...
                {/* Operating Hours */}
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm space-y-4">
                  <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Giờ hoạt động</h2>
                      ...
                      return (
                        <div key={day.key} className="flex items-center justify-between p-3 rounded-lg border border-gray-100 dark:border-gray-700/50 bg-gray-50/50 dark:bg-gray-800/50">
                          <div className="flex items-center gap-3 w-1/3">
                            ...
                            <span className="text-sm font-medium text-slate-900 dark:text-slate-100 w-20">{day.label}</span>
                          </div>
                          
                          {current.isOpen ? (
                            <div className="flex items-center gap-2 flex-1 justify-end">
                              <input type="time" value={current.open} onChange={(e) => updateOperatingHour(day.key, "open", e.target.value)} className="px-3 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-slate-900 dark:text-slate-100" />
                              <span className="text-gray-500">-</span>
                              <input type="time" value={current.close} onChange={(e) => updateOperatingHour(day.key, "close", e.target.value)} className="px-3 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-slate-900 dark:text-slate-100" />
                            </div>
                          ) : (
                            <div className="flex-1 text-right text-sm text-slate-400 dark:text-slate-500 italic">Đóng cửa</div>
                          )}
                        </div>
                      );
                    })}
                ...
                {/* Social Links */}
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm space-y-4">
                  <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Mạng xã hội</h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <input type="url" placeholder="https://facebook.com/..." value={formData.facebook} onChange={(e) => setFormData({...formData, facebook: e.target.value})} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-transparent text-slate-900 dark:text-slate-100" />
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2">
                      ...
                      <input type="url" placeholder="https://instagram.com/..." value={formData.instagram} onChange={(e) => setFormData({...formData, instagram: e.target.value})} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-transparent text-slate-900 dark:text-slate-100" />
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300 flex items-center gap-2">
                      ...
                      <input type="url" placeholder="https://tiktok.com/@..." value={formData.tiktok} onChange={(e) => setFormData({...formData, tiktok: e.target.value})} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-transparent text-slate-900 dark:text-slate-100" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeTab === "appearance" && (
              <div className="space-y-6">
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm space-y-6">
                  <div>
                    <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Hình ảnh Thương hiệu</h2>
                    <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Logo và ảnh bìa hiển thị trên trang chủ nhà hàng.</p>
                  </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1 space-y-2">
                          <input type="text" placeholder="URL của Logo" value={formData.logoUrl} onChange={(e) => setFormData({...formData, logoUrl: e.target.value})} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-transparent text-sm text-slate-900 dark:text-slate-100" />
                          <p className="text-xs text-slate-500 dark:text-slate-400">Nhấn vào ô vuông để tải ảnh lên hoặc dán URL.</p>
                        </div>
                      </div>
                    </div>

                    <div className="space-y-2">
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Ảnh bìa (Cover Image)</label>
                        ...
                        <div className="w-full h-32 rounded-lg bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 flex items-center justify-center overflow-hidden relative group-hover:opacity-80 transition-opacity">
                          {formData.coverImage ? (
                            ...
                            <div className="text-center">
                              ...
                              <span className="text-xs text-slate-500 mt-1 block">Tải ảnh bìa lên</span>
                            </div>
                          )}
                          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <input type="text" placeholder="URL của Ảnh bìa" value={formData.coverImage} onChange={(e) => setFormData({...formData, coverImage: e.target.value})} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-transparent text-sm mt-2 text-slate-900 dark:text-slate-100" />
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm space-y-4">
                  <div>
                    <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Màu sắc chủ đạo (Theme Color)</h2>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                      <input 
                        ...
                        value={formData.primaryColor} 
                        onChange={(e) => setFormData({...formData, primaryColor: e.target.value})}
                        className="px-3 py-1 border border-gray-300 dark:border-gray-600 rounded-lg bg-transparent text-sm w-28 uppercase font-mono text-slate-900 dark:text-slate-100"
                      />
                    </div>
                  ...
                  <div className="mt-4 p-4 border border-dashed border-gray-300 dark:border-gray-600 rounded-lg text-center">
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">Nút trên trang khách sẽ có màu này.</p>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Thư viện ảnh quán (Gallery)</h2>
                      <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Hình ảnh không gian quán, món ăn đẹp.</p>
                    </div>
                    <div className="flex gap-2">
                      <button 
                        ...
                        className="px-3 py-1.5 text-sm bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-slate-800 dark:text-slate-100 rounded-lg font-medium transition-colors"
                      >
                        Thêm từ URL
                      </button>
                  ...
                  {formData.gallery.length === 0 ? (
                    <div className="text-center py-8 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-dashed border-gray-300 dark:border-gray-600">
                      ...
                      <p className="text-sm text-slate-500 dark:text-slate-400">Chưa có ảnh nào trong thư viện.</p>
                    </div>
                  ) : (
            ...
            {activeTab === "reservation" && (
              <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Giờ bắt đầu nhận khách đặt bàn</label>
                      <input 
                        type="time" 
                    ...
                    <div className="space-y-1.5">
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Giờ ngưng nhận khách đặt bàn</label>
                      <input 
                        type="time" 
                    ...
                    <div className="space-y-1.5 md:col-span-2">
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300 block">
                        ...
                        <span className="text-xs text-slate-400 dark:text-slate-500 font-normal ml-1.5">(Mặc định: 60 phút)</span>
                      </label>
                      <input 
                        type="number" 
                        min={0}
                    ...
                    <div className="flex flex-col justify-between h-full">
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300 block mb-1.5">
                        ...
                        <span className="text-xs text-slate-400 dark:text-slate-500 font-normal ml-1.5">(Mặc định: 1 tiếng)</span>
                      </label>
                      <input 
                        type="number" 
                        min={0}
                    ...
                    <div className="flex flex-col justify-between h-full">
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300 block mb-1.5">
                        ...
                        <span className="text-xs text-slate-400 dark:text-slate-500 font-normal ml-1.5">(Mặc định: 30 ngày)</span>
                      </label>
                      <input 
                        type="number" 
                        min={1}
                    ...
                    <div className="space-y-1.5 md:col-span-2 mt-2">
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300 block">
                        ...
                        <span className="text-xs text-slate-400 dark:text-slate-500 font-normal ml-1.5">(Mặc định: 90 phút)</span>
                      </label>
                      <input 
                        type="number" 
                        min={30}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex flex-col justify-between h-full">
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300 block mb-1.5">
                        ...
                        <span className="text-xs text-slate-400 dark:text-slate-500 font-normal ml-1.5">(Mặc định: 15 phút)</span>
                      </label>
                      <input 
                        type="number" 
                        min={0}
                    ...
                    <div className="flex flex-col justify-between h-full">
                      <label className="text-sm font-medium text-slate-700 dark:text-slate-300 block mb-1.5">
                        ...
                        <span className="text-xs text-slate-400 dark:text-slate-500 font-normal ml-1.5">(Mặc định: 30 phút)</span>
                      </label>
                      <input 
                        type="number" 
                        min={1}
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Cấu hình tiền cọc bắt buộc để tránh khách ảo/bùng bàn.</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input 
                        type="checkbox" 
                  ...
                  {formData.reservationConfig.deposit_enabled && (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t border-gray-100 dark:border-gray-700/50 transition-all duration-300">
                      <div className="flex flex-col justify-between h-full">
                        <label className="text-sm font-medium text-slate-700 dark:text-slate-300 block mb-1.5">Số tiền cọc cố định (VND)</label>
                        <input 
                          type="number" 
                          min={0}
                      ...
                      <div className="flex flex-col justify-between h-full">
                        <label className="text-sm font-medium text-slate-700 dark:text-slate-300 block mb-1.5">
                          ...
                          <span className="text-xs text-slate-400 dark:text-slate-500 font-normal ml-1.5">(Mặc định: 120 phút)</span>
                        </label>
                        <input 
                          type="number" 
                          min={1}
                      ...
                      <div className="flex flex-col justify-between h-full">
                        <label className="text-sm font-medium text-slate-700 dark:text-slate-300 block mb-1.5">
                          ...
                          <span className="text-xs text-slate-400 dark:text-slate-500 font-normal ml-1.5">(Mặc định: 12 tiếng)</span>
                        </label>
                        <input 
                          type="number" 
                          min={0}
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm space-y-4">
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400">Khách hàng sẽ không thể đặt bàn vào các ngày này.</p>
                  ...
                  <div className="flex gap-2">
                    <input 
                      ...
                      className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-transparent text-slate-900 dark:text-slate-100"
                    />
                    <button
                      type="button"
                      onClick={() => {
                  ...
                  {formData.reservationConfig.closed_dates.length === 0 ? (
                    <div className="text-center py-6 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-dashed border-gray-300 dark:border-gray-600 text-sm text-slate-500 dark:text-slate-400">
                      Chưa cấu hình ngày nghỉ nào. Nhà hàng mở cửa tất cả các ngày trong năm.
                    </div>
                  ) : (
                    <div className="flex flex-wrap gap-2">
                      {formData.reservationConfig.closed_dates.map((date) => (
                        <div key={date} className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-slate-800 dark:text-slate-100 rounded-full text-sm transition-colors">
                          <span>{date}</span>
                          <button
                            type="button"
                            onClick={() => setFormData({
                            ...
                            className="w-4 h-4 bg-gray-300 dark:bg-gray-600 hover:bg-red-500 hover:text-white text-slate-600 dark:text-slate-300 rounded-full flex items-center justify-center text-xs font-bold transition-colors"
                          >
                            &times;
                          </button>
                        </div>
